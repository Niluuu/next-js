...
})(["background:#fff;width:200px;z-index:2;box-shadow:0 0 10px rgba(0,0,0,.02);opacity:0;visibility:hidden;-webkit-transition:.6s;-moz-transition:.6s;-o-transition:.6s;transition:.6s;"]);
function Nav() {
  return __jsx(Navbar, {
    __source: {
...
//# sourceMappingURL=index.js.12cddc509aa4f7670734.hot-update.js.map