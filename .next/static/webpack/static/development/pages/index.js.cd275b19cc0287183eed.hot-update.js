...
})(["background:#fff;color:#333;width:auto;z-index:2;box-shadow:0 0 10px rgba(0,0,0,.02);opacity:0;visibility:hidden;-webkit-transition:.6s;-moz-transition:.6s;-o-transition:.6s;transition:.6s;"]);
function Nav() {
  return __jsx(Navbar, {
    __source: {
...
//# sourceMappingURL=index.js.cd275b19cc0287183eed.hot-update.js.map